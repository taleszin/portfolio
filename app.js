(() => {
  ...
  const EN = {
    ...
    'also.eyebrow': 'Also live',
    'also.basquete': 'A panorama of adult basketball in Ceará: 916 player cards and 51 teams on a custom technical index. Box scores, stat sheets and a pipeline that reads the scoreboard from broadcasts with computer vision.',
    'also.edutopia': 'Teachers generate tests, activities, lesson plans and educational games with AI in about thirty seconds, ready to export as PDF and DOCX.',
    'also.enembot': 'A conversational tutor for the ENEM exam using the Feynman method: it leads the student to the answer instead of handing it over, with scoring, streaks and adaptive difficulty.',
    'games.eyebrow': '02 · Original games', 'games.title': 'Engines, art and sound', 'games.title2': 'built from scratch.',
    'games.lead': 'None of the three uses an off-the-shelf engine or purchased assets. Each has its own art direction, written in code.',
